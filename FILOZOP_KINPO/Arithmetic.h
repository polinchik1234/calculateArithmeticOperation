...
private:
	...
	*/
	...
	/**
	 * @brief Проверяет, является ли дробная часть числа нулевой.
	 * @param[in] fn Проверяемый объект FractionNumber.
	 * @return true, если дробная часть отсутствует или равна нулю.
	 */
